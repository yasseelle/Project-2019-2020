                                ...
                                <div class="inside">
                                    <form name="post" action="" method="post">
                                      <table class="plg-form-table">
                                            ...
                                            <i>If you don't want to use the WPSChoolPress Plugin on your site anymore, you can check the delete data box.This makes sure, that all the pages and tables are being deleted from the database when you delete the plugin.</i>
                                            ...
                                            <tr>
                                                ...
                                                <td class="plg-value">
                                                    ...
                                                    <br />
                                                    <i style="padding-top: 5px; display: block; font-weight: 500;">If you want to import demo data, click on Import Demo Data button</i>
                                                </td>
                                            </tr>
                                        </table>
