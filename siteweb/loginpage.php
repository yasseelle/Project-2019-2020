...
<div id="container">
  <main id="main">
    <div id="loginuicontainer">
      <div onclick="document.getElementById('registercontainer').style.display='none';document.getElementById('forget-email').style.display='none'; document.getElementById('register-tab').style.backgroundColor='#0000' ;document.getElementById('login-tab').style.backgroundColor='#337ab7';document.getElementById('logincontainer').style.display='block';" name="log" id="login-tab" class="actives">Login</div><div onclick="document.getElementById('registercontainer').style.display='block';  document.getElementById('logincontainer').style.display='none';document.getElementById('forget-email').style.display='none'; document.getElementById('login-tab').style.backgroundColor='#0000'; document.getElementById('register-tab').style.backgroundColor='#8B0000';"   name="log" id="register-tab">Register</div> 
      ...
      <div id="logincontainer">
        ...
        <div class="textcenter singuptxt"> Don't have an acount ?<a onclick="document.getElementById('registercontainer').style.display='block';  document.getElementById('logincontainer').style.display='none'; document.getElementById('login-tab').style.backgroundColor='#0000'; document.getElementById('register-tab').style.backgroundColor='#8B0000';" href="#" class="link registerlink">Sing Up</a></div>
              ...
              <p class="textcenter"> <a href="#" class="link forgetlink" onclick="document.getElementById('logincontainer').style.display='none';document.getElementById('login-tab').style.backgroundColor='#0000';document.getElementById('forget-email').style.display='block';document.getElementById('registercontainer').style.display='none'; ">Forget Password ?</a></p>
          <?php echo'<div class="textcenter singuptxt" style="color:'.@$_GET['$color'].';"> '.@$_GET['$msg']; ?></div>
      </div> 
    </form>
    <form action="includes/signup.inc.php" method="POST">
          ...
          <input type="text" class="form-contol inputbox" id="registration-lname" name="last" placeholder="Last Name" required>
             ...
             <div class="form-group">
          <input type="text" class="form-contol inputbox" id="registration-email" name="email"placeholder="Email ID / Username" required>
            </div>
            <div class="form-group">
          <input type="driver's license" class="form-contol inputbox" id="login-password" name="driverl" placeholder="DriveLicence" required>
            </div>
             <div class="form-group">
          <input type="password" class="form-contol inputbox" id="registration-password" name="pswd" placeholder="Password"required>
            </div>
            <div class="form-group">
          ...
          <form action="includes/forgetpass.inc.php" method="POST">
            ...
            <div class="form-group">
              <input type="text" class="form-contol inputbox" id="forget-email" name="femail" placeholder="email Addresse" required>
                </div>
                <div class="form-group">
              <input type="submit" class="btn btn-primary" onclick="document.getElementById('verefy-code').style.display='block';document.getElementById('forget-email').style.display='none';" value="verify">
            </div>
          </div>
          </form>
